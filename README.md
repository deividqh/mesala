...
> Nota de implementación: `cliente_web/imgs/Camarero.mp4` es un placeholder en texto para evitar bloqueo por binarios en este repositorio; la landing aplica fallback automático a un vídeo remoto si el navegador no puede reproducirlo como MP4.
...
|---|---|---|---|---|
| `cliente_web/index.html` | Navegación principal | `.mesala-navbar` | Estructura de navegación fija | Mantiene visibles las rutas críticas (Producto, Impacto, Demo, Prueba Gratis) durante todo el recorrido de la landing. |
| `cliente_web/index.html` | Menú responsive (Bootstrap collapse) | `#menuPrincipal` | Colapsar/expandir opciones en móvil | Reduce fricción en pantallas pequeñas y evita saturación visual. |
| `cliente_web/index.html` | CTA principal superior | Botón `a.btn.cta-primary[href="./mesala.html"]` | Acceso a producto | Lleva al entorno funcional de prueba (`mesala.html`) desde el primer viewport. |
...
| `cliente_web/index.html` | Módulo demo imagen principal | `#demo` + `img[src="./imgs/ejemplo_salon.jpg"]` | Prueba visual | Enseña interfaz del producto usando un recurso existente del proyecto. |
| `cliente_web/index.html` | Módulo demo móvil | `img[src="./imgs/estructura%20proyecto.jpg"]` | Prueba visual móvil | Aporta contexto visual adicional del flujo del producto en entorno real. |
...
|---|---|---|---|---|---|
| `cliente_web/index.html` | `#inicio` | Marca en navbar | `.navbar-brand` | Ancla interna al inicio | Link interno correcto; regresa al primer bloque de la landing. |
| `cliente_web/index.html` | `#valor` | Opción menú “Producto” | `a.nav-link[href="#valor"]` | Sección de valor | Link interno correcto; muestra diferenciadores clave de Mesala. |
| `cliente_web/index.html` | `#impacto` | Opción menú “Impacto” | `a.nav-link[href="#impacto"]` | Sección de métricas | Link interno correcto; concentra beneficios operativos resumidos. |
| `cliente_web/index.html` | `#demo` | Opción menú “Demo” | `a.nav-link[href="#demo"]` | Sección visual + vídeo | Link interno correcto; enseña producto en imágenes y video. |
| `cliente_web/index.html` | `./mesala.html` | Botón menú “Prueba Gratis” | `a.btn.cta-primary` (navbar) | Página de producto funcional | Link interno correcto relativo a `cliente_web/index.html`. |
